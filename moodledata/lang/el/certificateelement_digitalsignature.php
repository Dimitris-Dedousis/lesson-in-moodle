...
/**
 * Strings for component 'certificateelement_digitalsignature', language 'el', version '4.3'.
 *
...
$string['errormultipleimages'] = 'Μπορείτε να επιλέξετε μόνο μία εικόνα (είτε ανεβασμένη, είτε κοινόχρηστη)';
$string['height'] = 'Ύψος';
