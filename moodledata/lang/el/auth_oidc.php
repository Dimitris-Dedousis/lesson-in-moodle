...
/**
 * Strings for component 'auth_oidc', language 'el', version '4.3'.
 *
 * @package     auth_oidc
 * @category    string
...
$string['errorauthuseralreadyconnected'] = 'Είστε ήδη συνδεδεμένος/-η με ένα διαφορετικό χρήστη Σύνδεσης OpenID.';
$string['errorauthuserconnectedtodifferent'] = 'Ο χρήστης Σύνδεσης OpenID που αυθεντικοποιήθηκε είναι ήδη συνδεδεμένος σε ένα χρήστη του Moodle.';
$string['errorbadloginflow'] = 'Έχει καθοριστεί τύπος μη έγκυρη αυθεντικοποίηση. ΣΗΜΕΙΩΣΗ: Εάν λαμβάνετε αυτό το μήνυμα μετά από μια πρόσφατη εγκατάσταση ή αναβάθμιση, παρακαλούμε εκκαθαρίστε την κρυφή μνήμη του Moodle.';
...
$string['erroroidccall_message'] = 'Σφάλμα στη Σύνδεση OpenID: {$a}';
...
$string['erroroidcnotenabled'] = 'Το πρόσθετο αυθεντικοποίησης Σύνδεση OpenID δεν είναι ενεργοποιημένο.';
...
$string['oidc:manageconnectionconnect'] = 'Επιτρέπεται Σύνδεση OpenID';
$string['oidc:manageconnectiondisconnect'] = 'Επιτρέπεται Αποσύνδεση OpenID';
$string['pluginname'] = 'Σύνδεση OpenID';
...
$string['privacy:metadata:auth_oidc_token'] = 'Κουπόνια Σύνδεσης OpenID';
$string['privacy:metadata:auth_oidc_token:authcode'] = 'Ο κωδικός αυθεντικοποίησης για το κουπόνι';
