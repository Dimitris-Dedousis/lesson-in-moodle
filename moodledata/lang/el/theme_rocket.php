...
/**
 * Strings for component 'theme_rocket', language 'el', version '4.3'.
 *
...
$string['copyright'] = 'Σημείωση πνευματικών δικαιωμάτων';
$string['customcss'] = 'Προσαρμοσμένο CSS';
$string['disable'] = 'Απενεργοποιημένο';
$string['enable'] = 'Ενεργοποιημένο';
...
$string['region-search'] = 'Αναζήτηση / Προφίλ';
