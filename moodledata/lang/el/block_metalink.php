...
/**
 * Strings for component 'block_metalink', language 'el', version '4.3'.
 *
...
$string['cronnotmoved'] = 'Αδυναμία μετακίνησης {$a->old} στο {$a->new}. Παρακαλούμε, ελέγξτε τα δικαιώματα φακέλων.';
