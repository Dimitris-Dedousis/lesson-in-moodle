...
/**
 * Strings for component 'local_eledia_webservicesuite', language 'el', version '4.3'.
 *
...
$string['idnumberuser'] = 'Αναγνωριστικός αριθμός χρήστη';
$string['service_choose'] = 'επιλογή της λειτουργίας/συνάρτησης';
$string['start'] = 'κλήση λειτουργίας/συνάρτησης';
